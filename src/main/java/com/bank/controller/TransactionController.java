...
public class TransactionController {
	...
	@PostMapping("/transferMoneyByCard")
	public ResponseEntity<?> transferMoneyByCard(@RequestBody TransactionByCardReqDto transaction){
		return ResponseEntity.status(HttpStatus.OK).body(transactionService.transferMoneyByCard(transaction));
	}
}
